__MODEL_URL_PREFIX__ = "http://localhost:3000/lib"
/**
    * @license
    ...
    */
!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("@tensorflow/tfjs-core"), require("util"), require("@tensorflow/tfjs-data"), require("@tensorflow/tfjs-layers")) : "function" == typeof define && define.amd ? define(["exports", "@tensorflow/tfjs-core", "util", "@tensorflow/tfjs-data", "@tensorflow/tfjs-layers"], t) : t(e.speechCommands = {}, e.tf, null, e.tf.data, e.tf)
    ...
    var d = null;
    function p(e) {
        return null == d && (d = t.backend().epsilon()),
        t.tidy(function() {
            var r = t.moments(e)
              , n = r.mean
              , a = r.variance;
    ...
    var m = function() {
        function e(e) {
            ...
            if (!(e.numFramesPerSpectrogram > 0))
                throw new Error("Invalid value in numFramesPerSpectrogram: " + e.numFramesPerSpectrogram);
            if (e.suppressionTimeMillis < 0)
                throw new Error("Expected suppressionTimeMillis to be >= 0, but got " + e.suppressionTimeMillis);
            if (this.suppressionTimeMillis = e.suppressionTimeMillis,
            ...
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(a) {
                    ...
                    case 1:
                        ...
                        this.includeRawAudio && (this.timeDataQueue = [],
                        this.timeData = new Float32Array(this.fftSize)),
                        n = Math.max(1, Math.round(this.numFrames * (1 - this.overlapFactor))),
                        this.tracker = new y(n,Math.round(this.suppressionTimeMillis / this.frameDurationMillis)),
        ...
        e.prototype.onAudioFrame = function() {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(i) {
                    switch (i.label) {
                    case 0:
                        return this.analyser.getFloatFrequencyData(this.freqData),
                        this.freqData[0] === -1 / 0 ? [2] : (this.freqDataQueue.push(this.freqData.slice(0, this.columnTruncateLength)),
                        this.includeRawAudio && (this.analyser.getFloatTimeDomainData(this.timeData),
                        this.timeDataQueue.push(this.timeData.slice())),
                        this.freqDataQueue.length > this.numFrames && this.freqDataQueue.shift(),
                        this.tracker.tick() ? (e = g(this.freqDataQueue),
                        r = v(e, [1, this.numFrames, this.columnTruncateLength, 1]),
                        n = void 0,
                        this.includeRawAudio && (a = g(this.timeDataQueue),
                        n = v(a, [1, this.numFrames * this.fftSize])),
                        [4, this.spectrogramCallback(r, n)]) : [3, 2]);
                    case 1:
        ...
        e.prototype.stop = function() {
            return o(this, void 0, void 0, function() {
                return l(this, function(e) {
                    ...
                    return clearInterval(this.frameIntervalTask),
    ...
    function v(e, r) {
        ...
        return n.set(e, n.length - e.length),
        t.tensor(n, r)
    }
    var y = function() {
        function e(e, r) {
        ...
        return e.prototype.tick = function() {
            return this.counter++,
            this.counter % this.period == 0 && (null == this.suppressionOnset || this.counter - this.suppressionOnset > this.suppressionTime)
        }
        ,
    ...
    function x(e) {
        ...
        for (var t = unescape(encodeURIComponent(e)), r = new Uint8Array(t.length), n = 0; n < t.length; ++n)
            r[n] = t.charCodeAt(n);
        return r.buffer
    }
    function S(e) {
    ...
    var E = "TFJSSCDS"
      ...
      , F = function() {
        ...
        e.prototype.getData = function(e, r) {
            ...
            null != e ? t.util.assert(-1 !== i.indexOf(e), function() {
                return "Label " + e + " is not in the vocabulary (" + JSON.stringify(i) + ")"
            }) : t.util.assert(i.length > 1, function() {
                return "One-hot encoding of labels requires the vocabulary to have at least two words, but it has only " + i.length + " word."
            }),
            null == r && (r = {});
            var s, o, l = this.getSortedUniqueNumFrames();
            1 === l.length ? (s = null == r.numFrames ? l[0] : r.numFrames,
            o = null == r.hopFrames ? 1 : r.hopFrames) : (s = r.numFrames,
            t.util.assert(null != s && Number.isInteger(s) && s > 0, function() {
                return "There are " + l.length + " unique lengths among the " + a.size() + " examples of this Dataset, hence numFrames is required. But it is not provided."
            }),
            t.util.assert(s <= l[0], function() {
                return "numFrames (" + s + ") exceeds the minimum numFrames (" + l[0] + ") among the examples of the Dataset."
            }),
            o = r.hopFrames,
            t.util.assert(null != o && Number.isInteger(o) && o > 0, function() {
                return "There are " + l.length + " unique lengths among the " + a.size() + " examples of this Dataset, hence hopFrames is required. But it is not provided."
            }));
            var c = null == r.normalize || r.normalize;
            return t.tidy(function() {
                for (var l, h, d, f = [], m = [], g = [], v = 0; v < i.length; ++v) {
                    var y = i[v];
                    if (null == e || y === e) {
                        var b = a.label2Ids[y]
                          , w = function(n) {
                            var i, l, h = a.examples[n].spectrogram, b = h.frameSize;
                            null == d ? d = b : t.util.assert(b === d, function() {
                                return "Mismatch in frameSize  (" + b + " vs " + d + ")"
                            });
                            var w = h.data.length / b
                              , x = null;
                            "_background_noise_" !== y && (x = null == h.keyFrameIndex ? L(h).dataSync()[0] : h.keyFrameIndex);
                            var S = t.tensor3d(h.data, [w, b, 1])
                              , E = D(w, x, s, o)
                              , T = function(n) {
                                var a = t.tidy(function() {
                                    var e = t.slice(S, [n[0], 0, 0], [n[1] - n[0], -1, -1]);
                                    return c ? p(e) : e
                                });
                ...
                null != r.augmentByMixingNoiseRatio && a.augmentByMixingNoise(r.getDataset ? m : f, g, r.augmentByMixingNoiseRatio);
                ...
                if (r.getDataset) {
                    ...
                    var z = M.map(function(e) {
                      ...
                      , I = function(e, r, n) {
                        ...
                        g = 0; g < y; ++g)
                            for (var x = m[g], S = Math.round(x.length * (1 - n)), E = 0; E < x.length; ++E)
                    ...
                    E && (N = N.shuffle(m.length)),
                    N = N.batch(T).prefetch(4);
                ...
                var q = null == e ? t.cast(t.oneHot(t.tensor1d(g, "int32"), i.length), "float32") : void 0;
                return {
                    xs: t.stack(f),
                    ys: q
                }
        ...
        e.prototype.augmentByMixingNoise = function(e, r, n) {
            ...
            for (var s = e[0]instanceof Float32Array, o = this.getVocabulary(), l = [], c = [], d = 0; d < r.length; ++d)
                "_background_noise_" === o[r[d]] ? l.push(d) : c.push(d);
            if (0 === l.length)
                throw new Error("Cannot perform augmentation by mixing with noise when there is no example with label _background_noise_");
            var f = []
              , m = []
              , g = function(a) {
                var i, o, u = l[(i = 0,
                o = l.length,
                Math.floor((o - i) * Math.random()) + i)], c = s ? t.tensor1d(e[a]) : e[a], h = s ? t.tensor1d(e[u]) : e[u], d = t.tidy(function() {
                    return p(t.add(c, t.mul(h, n)))
                });
                s ? f.push(d.dataSync()) : f.push(d),
                m.push(r[a])
            };
            try {
        ...
        e.prototype.serialize = function(e) {
            ...
            e.forEach(function(e) {
                if (-1 === s.indexOf(e))
                    throw new Error('Word label "' + e + '" does not exist in the vocabulary of this dataset. The vocabulary is: ' + JSON.stringify(s) + ".")
            }));
            var o, l, c, h, d, p = [], f = [];
            try {
    ...
    function M(e) {
        ...
        return t && (r.rawAudioNumSamples = e.rawAudio.data.length,
    ...
    function D(e, r, n, a) {
        ...
        var o = Math.floor(n / 2)
          , l = r - o;
        for (l < 0 ? l = 0 : l + n > e && (l = e - n); !(l - a < 0 || r >= l - a + n); )
            l -= a;
        for (; l + n <= e && !(r < l); )
            i.push([l, l + n]),
            l += a;
    ...
    var C = function() {
        function e(r, n, a) {
            //this.MODEL_URL_PREFIX = "https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v" + A.split(".").slice(0, 2).join(".") + "/browser_fft",
            this.MODEL_URL_PREFIX = __MODEL_URL_PREFIX__
            ...
            this.metadataOrURL = this.MODEL_URL_PREFIX + "/" + this.vocabulary + "/metadata.json") : (t.util.assert(null == r, function() {
            ...
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(f) {
                    ...
                    case 1:
                        ...
                        return i = null == r.overlapFactor ? .5 : r.overlapFactor,
                        t.util.assert(i >= 0 && i < 1, function() {
                            return "Expected overlapFactor to be >= 0 and < 1, but got " + i
                        }),
                        s = function(i, s) {
                            return o(d, void 0, void 0, function() {
                                ...
                                return l(this, function(l) {
                                    ...
                                    case 0:
                                        return s = p(i),
                                        r.includeEmbedding ? [4, this.ensureModelWithEmbeddingOutputCreated()] : [3, 2];
                                    case 1:
                                        return l.sent(),
                                        w = c(this.modelWithEmbeddingOutput.predict(s), 2),
                                        o = w[0],
                                        u = w[1],
                                        [3, 3];
                                    case 2:
                                        o = this.model.predict(s),
                                        l.label = 3;
                                    case 3:
                                        return [4, o.data()];
                                    case 4:
                                    ...
                                    case 8:
                                        return b = !0,
                                        a || "_background_noise_" !== this.words[m] && "_unknown_" !== this.words[m] || (b = !1),
                                        b && e({
                                            scores: d,
                                            spectrogram: v,
                                            embedding: u
                        ...
                        ,
                        u = null == r.suppressionTimeMillis ? this.DEFAULT_SUPPRESSION_TIME_MILLIS : r.suppressionTimeMillis,
        ...
        e.prototype.ensureModelLoaded = function() {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(o) {
                    ...
                    case 1:
                        return o.sent(),
                        "string" != typeof this.modelArtifactsOrURL ? [3, 3] : [4, a.loadLayersModel(this.modelArtifactsOrURL)];
                    case 2:
                        return e = o.sent(),
                        [3, 5];
                    case 3:
                        return [4, a.loadLayersModel(t.io.fromMemory(this.modelArtifactsOrURL.modelTopology, this.modelArtifactsOrURL.weightSpecs, this.modelArtifactsOrURL.weightData))];
                    case 4:
                        e = o.sent(),
                        o.label = 5;
                    case 5:
                        if (1 !== e.inputs.length)
                            throw new Error("Expected model to have 1 input, but got a model with " + e.inputs.length + " inputs");
                        if (4 !== e.inputs[0].shape.length)
                            throw new Error("Expected model to have an input shape of rank 4, but got an input shape of rank " + e.inputs[0].shape.length);
                        if (1 !== e.inputs[0].shape[3])
                            throw new Error("Expected model to have an input shape with 1 as the last dimension, but got input shape" + JSON.stringify(e.inputs[0].shape[3]) + "}");
                        if (2 !== (r = e.outputShape).length)
                            throw new Error("Expected loaded model to have an output shape of rank 2,but received shape " + JSON.stringify(r));
                        if (r[1] !== this.words.length)
                            throw new Error("Mismatch between the last dimension of model's output shape (" + r[1] + ") and number of words (" + this.words.length + ").");
                        return this.model = e,
                        this.freezeModel(),
        ...
        e.prototype.ensureModelWithEmbeddingOutputCreated = function() {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(r) {
                    ...
                    case 1:
                        for (r.sent(),
                        t = this.model.layers.length - 2; t >= 0; --t)
                        ...
                        return this.modelWithEmbeddingOutput = a.model({
        ...
        e.prototype.warmUpModel = function() {
            var e = this;
            t.tidy(function() {
                for (var r = t.zeros([1].concat(e.nonBatchInputShape)), n = 0; n < 3; ++n)
                    e.model.predict(r)
            })
        }
        ,
                            ...
                            return o(this, void 0, void 0, function() {
                                ...
                                return l(this, function(l) {
                                    ...
                                    case 0:
                                        ...
                                        n = "https://",
                                        a = "file://",
                                        0 !== e.indexOf(t) && 0 !== e.indexOf(n) ? [3, 3] : [4, fetch(e)];
                                    case 1:
                                        return [4, l.sent().json()];
                                    case 2:
                                        return [2, l.sent()];
                                    case 3:
                                        return 0 !== e.indexOf(a) ? [3, 5] : (i = require("fs"),
                                        s = r.promisify(i.readFile),
                                        u = (o = JSON).parse,
                                        [4, s(e.slice(a.length), {
                                            encoding: "utf-8"
                                        })]);
                                    case 4:
        ...
        e.prototype.recognize = function(e, r) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(l) {
                    ...
                    case 1:
                        return l.sent(),
                        null != e ? [3, 3] : [4, this.recognizeOnline()];
                    case 2:
                        n = l.sent(),
                        e = n.data,
                        l.label = 3;
                    ...
                    case 4:
                        ...
                        [3, 6];
                    case 5:
                        s = this.model.predict(i),
                        l.label = 6;
                    case 6:
                        return 1 !== a ? [3, 8] : (c = o,
                        [4, s.data()]);
                    case 7:
                        return c.scores = l.sent(),
                        [3, 10];
                    case 8:
                        return h = t.unstack(s),
                        d = h.map(function(e) {
                            return e.data()
                        }),
                        p = o,
                    ...
                    case 9:
                        ...
                        l.label = 10;
                    case 10:
                        return r.includeSpectrogram ? (f = o,
                        m = {},
                        e instanceof t.Tensor ? [4, e.data()] : [3, 12]) : [3, 14];
                    case 11:
                        return g = l.sent(),
                        [3, 13];
                    case 12:
                                ...
                                return o(e, void 0, void 0, function() {
                                    ...
                                    return l(this, function(i) {
                                        ...
                                        case 1:
                                            ...
                                            [4, e.data()];
                                        case 2:
                                            return n.apply(void 0, [(a.data = i.sent(),
        ...
        e.prototype.createTransfer = function(e) {
            ...
            return this.transferRecognizers[e] = r,
            r
        }
        ,
        e.prototype.freezeModel = function() {
            var e, t;
            try {
                for (var r = u(this.model.layers), n = r.next(); !n.done; n = r.next()) {
                    n.value.trainable = !1
                }
            } catch (t) {
                e = {
        ...
        e.prototype.checkInputTensorShape = function(e) {
            ...
            if (e.shape.length !== r)
                throw new Error("Expected input Tensor to have rank " + r + ", but got rank " + e.shape.length + " that differs ");
            var n = e.shape.slice(1)
              , a = this.model.inputs[0].shape.slice(1);
            if (!t.util.arraysEqual(n, a))
                throw new Error("Expected input to have shape [null," + a + "], but got shape [null," + n + "]")
        }
        ,
      ...
      , _ = function(e) {
        ...
        r.prototype.collectExample = function(e, r) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(c) {
                    ...
                    n = Math.ceil(r.durationSec / a)) : null != r.durationMultiplier ? (t.util.assert(r.durationMultiplier >= 1, function() {
                        return "Expected duration multiplier to be >= 1, but got " + r.durationMultiplier
                    }),
                    n = Math.round(this.nonBatchInputShape[0] * r.durationMultiplier)) : n = this.nonBatchInputShape[0],
                    null != r.snippetDurationSec && (t.util.assert(r.snippetDurationSec > 0, function() {
                    ...
                    [2, new Promise(function(t) {
                        var a = null == r.snippetDurationSec ? 1 : r.snippetDurationSec / s
                          , i = 1 - a
                          , c = Math.round(1 / a)
                          , h = 0
                          , d = -1
                        ...
                        u.audioDataExtractor = new m({
                            ...
                            spectrogramCallback: function(n, a) {
                                return o(u, void 0, void 0, function() {
                                    var i, s, o, u, m, v, y, b, x, S, E, T, F, M, z, D, I, L, A, R;
                                    return l(this, function(l) {
                                        switch (l.label) {
                                        case 0:
                                            return null != r.onSnippet ? [3, 7] : (i = p(n),
                                            ...
                                            [4, i.data()]);
                                        case 1:
                                            return u.spectrogram = (m.data = l.sent(),
                                            m.frameSize = this.nonBatchInputShape[1],
                                            m),
                                            r.includeRawAudio ? (y = {},
                                            [4, a.data()]) : [3, 3];
                                        case 2:
                                            return y.data = l.sent(),
                                            y.sampleRateHz = this.audioDataExtractor.sampleRateHz,
                                            v = y,
                                            [3, 4];
                                        case 3:
                                            v = void 0,
                                        ...
                                        case 5:
                                            ...
                                            [4, n.data()];
                                        case 6:
                                            return b.apply(void 0, [(x.data = l.sent(),
                                        ...
                                        case 8:
                                            ...
                                            g.push(F),
                                            null != r.onSnippet && r.onSnippet({
                                                data: F,
                                                frameSize: this.nonBatchInputShape[1]
                                            }),
                                            h++ !== c ? [3, 13] : [4, this.audioDataExtractor.stop()];
                                        case 9:
                                            return l.sent(),
                                            this.streaming = !1,
                                            this.collateTransferWords(),
                                            ...
                                            [4, a.data()]) : [3, 11];
                                        case 10:
                                            return R.data = l.sent(),
                                            R.sampleRateHz = this.audioDataExtractor.sampleRateHz,
                                            A = R,
                                            [3, 12];
                                        case 11:
                                            A = void 0,
        ...
        r.prototype.collectTransferDataAsTfDataset = function(e, t, r, n) {
            ...
            return this.dataset.getData(null, s({
                numFrames: a,
                hopFrames: i,
                getDataset: !0,
                datasetBatchSize: r,
        ...
        r.prototype.train = function(e) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(a) {
                    ...
                    this.dataset.durationMillis() > r ? (console.log("Detected large dataset: total duration = " + this.dataset.durationMillis() + " ms > " + r + " ms. Training transfer model using fitDataset() instead of fit()"),
                    [2, this.trainOnDataset(e)]) : [2, this.trainOnTensors(e)]
                })
            })
        }
        ,
            ...
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(l) {
                    ...
                    case 0:
                        ...
                        n = e.windowHopRatio || .25,
                        a = c(this.collectTransferDataAsTfDataset(n, e.validationSplit, r, {
                            augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio
                        }), 2),
                        i = a[0],
                        s = a[1],
                        o = t.util.now(),
                        [4, this.model.fitDataset(i, {
                            epochs: e.epochs,
                    ...
                    case 1:
                        return u = l.sent(),
                        console.log("fitDataset() took " + (t.util.now() - o).toFixed(2) + " ms"),
                        null != e.fineTuningEpochs && e.fineTuningEpochs > 0 ? (h = t.util.now(),
                        [4, this.fineTuningUsingTfDatasets(e, i, s)]) : [3, 3];
                    case 2:
                        return d = l.sent(),
                        console.log("fitDataset() (fine-tuning) took " + (t.util.now() - h).toFixed(2) + " ms"),
                        [2, [u, d]];
                    case 3:
                        return [2, u]
                    }
            ...
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(l) {
                    ...
                    case 1:
                        ...
                        null != e.validationSplit ? (c = function(e, r, n) {
                            return t.util.assert(n > 0 && n < 1, function() {
                                return "validationSplit is expected to be >0 and <1, but got " + n
                            }),
                            t.tidy(function() {
                                for (var a = t.argMax(r, -1).dataSync(), i = [], s = 0; s < a.length; ++s) {
                                    var o = a[s];
                                    null == i[o] && (i[o] = []),
                                    i[o].push(s)
                                }
                                ...
                                s = 0; s < l; ++s)
                                    for (var h = i[s], d = Math.round(h.length * (1 - n)), p = 0; p < h.length; ++p)
                        ...
                        s = c.trainXs,
                        o = c.trainYs,
                        u = [c.valXs, c.valYs]) : (s = a,
                        o = i),
                        [4, this.model.fit(s, o, {
                    ...
                    case 2:
                        return h = l.sent(),
                        null != e.fineTuningEpochs && e.fineTuningEpochs > 0 ? [4, this.fineTuningUsingTensors(e, s, o, u)] : [3, 4];
                    case 3:
                        return d = l.sent(),
                        [2, [h, d]];
                    case 4:
        ...
        r.prototype.fineTuningUsingTfDatasets = function(e, t, r) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(s) {
                    switch (s.label) {
                    case 0:
                        return n = this.secondLastBaseDenseLayer.trainable,
        ...
        r.prototype.fineTuningUsingTensors = function(e, t, r, n) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(o) {
                    switch (o.label) {
                    case 0:
                        return a = this.secondLastBaseDenseLayer.trainable,
                        this.secondLastBaseDenseLayer.trainable = !0,
        ...
        r.prototype.evaluate = function(e) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(a) {
                    ...
                    [2, t.tidy(function() {
                        for (var a = [], i = 0, s = n.collectTransferDataAsTensors(e.windowHopRatio), o = s.xs, l = s.ys.argMax(-1).dataSync(), u = n.model.predict(o), c = t.max(t.slice(u, [0, 1], [u.shape[0], u.shape[1] - 1]), -1), h = u.shape[0], d = 0; d < e.wordProbThresholds.length; ++d) {
                            for (var p = e.wordProbThresholds[d], f = c.greater(t.scalar(p)).dataSync(), m = 0, g = 0, v = 0, y = 0, b = 0; b < h; ++b)
                                l[b] === r ? (m++,
                                f[b] && v++) : (g++,
                                f[b] && y++);
                            var w = v / m
        ...
        r.prototype.createTransferModelFromBaseModel = function() {
            ...
            for (var r = this.baseModel.layers, n = r.length - 2; n >= 0 && "dense" !== r[n].getClassName().toLowerCase(); )
                n--;
            if (n < 0)
            ...
            this.transferHead.add(a.layers.dense({
        ...
        r.prototype.save = function(e) {
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(a) {
                    return t = null != e,
                    e = e || N(this.name),
                    t || (r = k.localStorage.getItem(R),
                    (n = null == r ? {} : JSON.parse(r))[this.name] = this.getMetadata(),
            ...
            return o(this, void 0, void 0, function() {
                ...
                return l(this, function(i) {
                    ...
                    case 0:
                        ...
                        e = e || N(this.name),
                        !t) {
                            if (null == (r = JSON.parse(k.localStorage.getItem(R))) || null == r[this.name])
                        ...
                        return n = this,
                        [4, a.loadLayersModel(e)];
                    case 1:
                        return n.model = i.sent(),
    ...
    e.deleteSavedTransferModel = function(e) {
        return o(this, void 0, void 0, function() {
            ...
            return l(this, function(n) {
                switch (n.label) {
                case 0:
                    return null == (r = JSON.parse(k.localStorage.getItem(R))) && (r = {}),
                    null != r[e] && delete r[e],
